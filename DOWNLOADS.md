...
## 最新版：VoxDirector v0.2.1

VoxDirector 是 VoxCPM Easy Launcher 的大版本升级，新增长文本配音、智能断句、Director Table 手动编辑、自动情绪提示词、连续音色拼接、界面语言切换和长任务实时进度显示。

### macOS Apple Silicon

- **File / 文件：** `VoxDirector-macOS-Lite.zip`
- **Download / 下载：** [GitHub Release](https://github.com/songjiankindle-web/VoxDirector/releases/download/v0.2.1/VoxDirector-macOS-Lite.zip)
- **SHA-256：** `a1c7e157aeeba72833a9360b4ac330fc98820df6d6e7c667d8e23c3f4eb48e1c`
...
- **Download / 下载：** [GitHub Release](https://github.com/songjiankindle-web/VoxDirector/releases/download/v0.2.1/VoxDirector-Windows-Lite.zip)
- **SHA-256：** `35a585b41f6082d3a834af293b9a782112cf19796367ee3d158ce28f640a8829`
